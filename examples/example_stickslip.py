...
from pathsim.solvers import RKCK54, ESDIRK54
...
Sim = Simulation(blocks, connections, dt=0.01, log=True, Solver=ESDIRK54, tolerance_lte_abs=1e-6, tolerance_lte_rel=1e-3)
