...
class TestGraph(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # --- Connections for Acyclic Mixed Graph ---
        ...
        # --- Connections for Algebraic Loop Graph ---
        # Loop: add2 -> amp1 -> add2
        ...
        # --- Connections for Dynamic Loop Graph ---
        # Loop: int1 -> int2 -> int1
    ...
    def test_init_with_dynamic_loop(self):
        ...
        self.assertFalse(g.has_loops) # Correct: No *algebraic* loop
    ...
    def test_has_loops_mixed_true_via_integrator(self):
        ...
        # Connection needed: Connection(self.int2, self.amp1) -> NEW
    ...
    def test_depth_acyclic_mixed(self):
        ...
        self.assertEqual(alg_depth, 4) # Corrected
        self.assertEqual(loop_depth, 0)
    ...
    def test_depth_algebraic_loop(self):
        ...
        self.assertEqual(alg_depth, 0) # Corrected
        self.assertEqual(loop_depth, 2) # Corrected
    ...
    def test_depth_dynamic_loop(self):
        ...
        self.assertEqual(alg_depth, 1) # Corrected
        self.assertEqual(loop_depth, 0) # Corrected
    ...
    def test_dag_traversal_mixed(self):
        ...
        # Based on corrected depth analysis:
        # Depth 0: [int1] (upstream depth 0)
        # Depth 1: [amp1] (upstream depth 1)
        # Depth 2: [add1] (max upstream depth is 1 (from amp1) + len(add1)=1 -> 2)
        # Depth 3: [amp2, int2] (max upstream depth is 2 (from add1) + len(amp2)=1 -> 3; int2 upstream depth is 3)
